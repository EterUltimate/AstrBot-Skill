...
## 安装相关
### Windows安装失败
Windows出现venv安装失败、启动失败，请优先尝试[手动uv部署](https://docs.astrbot.app/deploy/astrbot/cli.html#%E5%AE%89%E8%A3%85%E4%BE%9D%E8%B5%96%E5%B9%B6%E8%BF%90%E8%A1%8C)。如果无法解决，请进群提供报错截图！
### Linux安装失败
...
```
运行无报错则回到NapCat的Webui，网络配置中，将你之前填写的`ws://127.0.0.1:6099/ws`修改为`ws://astrbot:6099/ws`
2. 如果只有NapCat是docker部署，那么请将`ws://127.0.0.1:6099/ws`修改为`ws://宿主机IP:6099/ws`（宿主机IP请自行搜索如何查看）
## 管理面板相关
