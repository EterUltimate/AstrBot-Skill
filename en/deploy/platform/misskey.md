...
![Create Misskey Platform Adapter](/source/images/misskey/create.png)
...
![Misskey Platform Adapter Configuration](/source/images/misskey/config.png)
...
![Open Misskey Connected Services Page](/source/images/misskey/pat-1.png)

2. Click "Generate Access Token" to generate an account access token.

![Generate Misskey Account Token](/source/images/misskey/pat-2.png)
...
![Configure Access Token Permissions](/source/images/misskey/pat-3.png)
...
![View Account Token](/source/images/misskey/pat-4.png)
...
![Demo Example](/source/images/misskey/demo.png)
...
![This is a bot account](/source/images/misskey/botset.png)
